...
[![Greenkeeper badge](https://badges.greenkeeper.io/squirrellyjs/squirrelly-next.svg)](https://greenkeeper.io/)
...
[![Dev Dependencies](https://david-dm.org/squirrellyjs/squirrelly-next/dev-status.svg)](https://david-dm.org/squirrellyjs/squirrelly-next?type=dev)
[![Donate](https://img.shields.io/badge/donate-paypal-blue.svg)](https://paypal.me/bengubler)

New, more powerful version of Squirrelly

### Usage

```bash
git clone https://github.com/squirrellyjs/squirrelly-next.git YOURFOLDERNAME
cd YOURFOLDERNAME
