...
describe('Compile to String test', () => {
  ...
  it('works with helpers', () => {
    ...
    expect(str).toEqual(
      "var tR='';tR+=c.l('H','each')({exec:function(hi){var tR='';tR+=' Hey ';return tR},params:[x]},[{exec:function(){var tR='';tR+=' oops ';return tR},params:[],name:'else'},]);return tR"
    )
  })
  ...
  it('works with self-closing helpers', () => {
    ...
    expect(str).toEqual("var tR='';tR+=c.l('F','hi')(c.l('H','log')(\"hey\"));return tR")
  })

  it('works with helpers with results', () => {
    var str = CompileToString('{{~log ("hey") => res, res2}}{{/log}}', defaultConfig)
    expect(str).toEqual(
      "var tR='';tR+=c.l('H','log')({exec:function(res, res2){var tR='';return tR},params:[\"hey\"]},[]);return tR"
    )
  })
